...
MAX_RETRIES = 3
CONCURRENCY = 3
REQUEST_DELAY = 1.5  # karar indirmeleri arası; sunucuyu yormamak için nazikçe geniş tutuldu
RATE_LIMIT_BACKOFF = 5.0  # getDokuman 429 dönüp Retry-After vermediğinde beklenecek süre (sn)
